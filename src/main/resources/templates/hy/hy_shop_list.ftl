...
<html>
	...
	<body>
		<div class="admin-main">
          <form id="form" action="${request.contextPath}/backpage/hyShop/list" method="post">
			<blockquote class="layui-elem-quote">
		                 ...
		                 联系人：<div class="layui-input-inline"><input type="text" name="shopContacts" value="${(record.shopContacts)!''}" id="shopContacts" /></div>   
                          
		       <a href="javascript:;" class="layui-btn layui-btn-small" id="search">
					<i class="layui-icon">&#xe615;</i> 搜索
				</a>
				<#if notParent=='0'> <a href="${request.contextPath}/backpage/hyShop/toinput" class="layui-btn layui-btn-small">
						...
						<#list page.list as record>
						    <tr>
								...
								<div class="layui-btn-group">
								    <a href="${request.contextPath}/backpage/hyShopBranch/list?parentId=${record.id}"  class="layui-btn layui-btn-mini">分店列表</a>
									<a href="${request.contextPath}/backpage/hyShop/toinput?id=${record.id}"  class="layui-btn layui-btn-mini">修改</a>
								</div>
								</td>
							</tr>
						</#list>
			...
			layui.use(['icheck', 'laypage','layer'], function() {
				...
				laypage({
					...
					jump: function(obj, first) {
						...
						if(!first) {
						 $.ajax({
				           url:'${request.contextPath}/backpage/hyShop/getList',
				           type:'post',
				           ...
				           success:function(data) { 
                            ...
                            $.each(data.data.list,function(i,val){
							    ...
							    str += '<a href="${request.contextPath}/backpage/hyShopBranch/list?parentId='+val.id+'"  class="layui-btn layui-btn-mini">分店列表</a>'
                                str += '<a href="${request.contextPath}/backpage/hyShop/toinput?id='+val.id+'"  class="layui-btn layui-btn-mini">修改</a>'
                                str += '</div></td>'
                                str += '</tr>'
