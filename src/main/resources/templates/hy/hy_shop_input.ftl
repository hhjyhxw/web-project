	...
	<body>
		<div style="margin: 15px;">
			...
			<form class="layui-form" <#if shop??>action="${request.contextPath}/backpage/hyShop/update"<#else>action="${request.contextPath}/backpage/hyShop/add"</#if> id="form">
			   ...
			   <#if shop??><input type="hidden" name="bak2" value="${(shop.bak2)!'1'}"></#if>
				...
				<div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                   <select name="parentId" style="width: 250px;" lay-filter="demo1" >
                        <option value="0">新增总店</option>
                ...
                <div class="layui-form-item discount">
                    <label class="layui-form-label">店铺折扣</label>
                    <div class="layui-input-block">
                        <input type="text" name="discount" <#if shop??>value="${shop.discount!'10'}" <#else>value="10"</#if>  lay-verify="required" autocomplete="off" placeholder="店铺折扣" class="layui-input" style="width:250px;">
                    </div>
                </div>
