	...
	<script>
            ...
            layui.use(['form','jquery'], function() {
                var form = layui.form(),
                    ...
                    var formurl = '';
                    if($('#id').val()!=''){
                        formurl = "${request.contextPath}/backpage/houseFollowRecords/update";
                    }else{
                         formurl = "${request.contextPath}/backpage/houseFollowRecords/add";
                    }
                    debugger;
                //监听提交
                       ...
                       $.ajax({
                           ...
                           success:function(data) {
                             if("0000"==data.code){
                               ...
                               setTimeout(function(){window.location="${request.contextPath}/backpage/houseFollowRecords/list"},500);
                              }else{
