	...
	<form class="layui-form" action="" name="actionForm" method="POST" enctype="multipart/form-data" id="form">
		...
		<fieldset class="layui-elem-field" style="width: 60%; text-align: center; margin-left: 20%;">
            ...
            <div class="layui-form-mid layui-word-aux"><span style="color:red;">*</span></div>
                             ...
                             <div class="layui-form-item">
            <label class="layui-form-label">申请状态(0待审批、1审批种、2申请成功)</label>
            <div class="layui-input-inline" style="width:70%">
	...
	<script>
            ...
            layui.use(['form','jquery'], function() {
                var form = layui.form(),
                    ...
                    var formurl = '';
                    if($('#id').val()!=''){
                        formurl = "${request.contextPath}/backpage/houseApply/update";
                    }else{
                         formurl = "${request.contextPath}/backpage/houseApply/add";
                    }
                    debugger;
                //监听提交
                       ...
                       $.ajax({
                           ...
                           success:function(data) {
                             if("0000"==data.code){
                               ...
                               setTimeout(function(){window.location="${request.contextPath}/backpage/houseApply/list"},500);
                              }else{
